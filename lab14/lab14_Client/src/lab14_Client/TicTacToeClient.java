...
public class TicTacToeClient extends JFrame implements Runnable {
	...
	private boolean gameOver = false;// mark for game over
	...
	public TicTacToeClient(String host) {
		...
		setSize(330, 250); // set size of window
	...
	private void processMessage(String message) {
		...
		if (message.equals("Valid move.")) {
			...
			gameOver = true;
			// "X"表示"X"赢，"O"表示"O"赢，"D"表示平局
			String result = input.nextLine();
			if (result.equals(myMark)) { // 当前用户赢
				displayMessage("You win" + "\n");
				JOptionPane.showMessageDialog(TicTacToeClient.this, "You Win!");

			} else if (result.equals("D")) { // 平局
				displayMessage("The game has drawn" + "\n");
				JOptionPane.showMessageDialog(TicTacToeClient.this, "The game has drawn!");
			} else { // 当前用户失败
